...
Copyright © 2006-2017 by Chavdar Kostov
...
===============================================
The application is designed to use a free Weather Underground developer account which limits you to 500 calls per day/10 calls per minute.
...
Of course if you already have an API key (free or paid) from Weather Underground API you can use it too.
