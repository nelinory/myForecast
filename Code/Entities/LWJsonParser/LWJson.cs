...
namespace LightWeightJsonParser
{
    public abstract class LWJson
    {
        ...
        public virtual LWJsonObject AsObject()
        {
            if (this is LWJsonObject)
                return this as LWJsonObject;
            else
                throw new InvalidCastException($"Cannot cast object of type {DataType} to Object");
        }
        /// <summary>
        /// Returns this item as a JSON array.
        /// </summary>
        /// <returns>The JSON array representation of this item.</returns>
        public virtual LWJsonArray AsArray()
        {
            if (this is LWJsonArray)
                return this as LWJsonArray;
            else
                throw new InvalidCastException($"Cannot cast object of type {DataType} to Array");
        }
        /// <summary>
        ...
        public virtual LWJsonValue AsValue()
        {
            if (this is LWJsonValue)
                return this as LWJsonValue;
            else
                throw new InvalidCastException($"Cannot cast object of type {DataType} to Value");
        }
        #endregion
